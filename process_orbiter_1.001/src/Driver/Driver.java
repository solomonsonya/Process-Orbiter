...
import java.net.Socket;
	...
	public class Driver 
	{
		public static final String NAME = "Process Orbiter";
		...
		//start the parser to read in the file
			...
			try
			{
				...
				while((line = br.readLine()) != null)
				{
					...
					if(this.isWindows)
					{
						...
						directive("  tshark iface num [" + interface_number + "] name -->" + interface_name);
		...
		public boolean print_interfaces()
		{
			try
			{			
				LinkedList<String> list_interfaces = list_interfaces(false, null);
			...
			{
				eop(myClassName, "print_interfaces", e);
			}
		...
		public boolean DEPRECATED_display_status()
		{
			try
			{
				directive("\n/// STATUS ///");
